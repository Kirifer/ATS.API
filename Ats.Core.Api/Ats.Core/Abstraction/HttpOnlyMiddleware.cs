...
namespace Ats.Core.Abstraction
{
    public class HttpOnlyMiddleware
    {
        ...
        private void UpdateAuthenticationContext(HttpContext context)
        {
            ...
            bool jwtHeaderIsNotPresent = !context.Request.Headers.ContainsKey(GlobalConstants.HttpHeaderAuthorization);
            ...
            if (jwtHeaderIsNotPresent && jwtCookieIsExisting)
            {
                ...
                context.Request.Headers.Append(GlobalConstants.HttpHeaderAuthorization, $"Bearer {jwtCookie}");
            }
        }
    }
}
